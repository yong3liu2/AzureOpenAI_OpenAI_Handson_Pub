...
faiss_retriever_all = create_retriever_tool(
    faiss_retriever,
    "SEC data search",
    "This tool is help looking for information about the company, Zebra Technologies, using its all U.S. Securities and Exchange Commission (SEC) filing reports, like 10-K, 10-Q, 8-K ...",
)
...
def build_question_prompt(company_name, question):
    prompt_text = f"Please answer the following question: {question}. \
